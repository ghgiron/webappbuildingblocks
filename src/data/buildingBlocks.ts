...
export const BUILDING_BLOCKS: BuildingBlock[] = [
  ...
  // =========================================================================
  {
    ...
    shape: {
      pathD: 'M 275,35 L 330,35 L 300,215 L 195,215 Z',
      centerX: 265,
      centerY: 125,
  ...
  },
  {
    ...
    shape: {
      pathD: 'M 330,35 L 390,35 L 440,215 L 300,215 Z',
      centerX: 365,
      centerY: 125,
  ...
  },
  {
    ...
    shape: {
      pathD: 'M 390,35 L 445,35 L 565,215 L 440,215 Z',
      centerX: 465,
      centerY: 125,
  ...
  },
  {
    ...
    shape: {
      pathD: 'M 195,215 L 370,215 L 370,430 L 105,430 Z',
      centerX: 260,
      centerY: 325,
  ...
  },
  {
    ...
    shape: {
      pathD: 'M 370,215 L 565,215 L 695,430 L 370,430 Z',
      centerX: 510,
      centerY: 325,
  ...
  // =========================================================================
  {
    ...
    shape: {
      pathD: 'M 105,430 L 285,430 L 285,625 L 105,625 Z',
      centerX: 195,
      centerY: 528,
  ...
  },
  {
    ...
    shape: {
      pathD: 'M 285,430 L 515,430 L 515,625 L 285,625 Z',
      centerX: 400,
      centerY: 528,
      shapeClass: 'clip-rect-room',
      clipPathCss: 'polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)',
  ...
  },
  {
    ...
    shape: {
      pathD: 'M 515,430 L 695,430 L 695,625 L 515,625 Z',
      centerX: 605,
      centerY: 528,
      shapeClass: 'clip-rect-room',
      clipPathCss: 'polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)',
  ...
  },
  {
    ...
    shape: {
      pathD: 'M 105,625 L 285,625 L 285,820 L 105,820 Z',
      centerX: 195,
      centerY: 722,
      shapeClass: 'clip-rect-room',
      clipPathCss: 'polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)',
  ...
  },
  {
    ...
    shape: {
      pathD: 'M 285,625 L 515,625 L 515,820 L 285,820 Z',
      centerX: 400,
      centerY: 722,
  ...
  },
  {
    ...
    shape: {
      pathD: 'M 515,625 L 695,625 L 695,820 L 515,820 Z',
      centerX: 605,
      centerY: 722,
      shapeClass: 'clip-rect-room',
      clipPathCss: 'polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)',
  ...
  // =========================================================================
  {
    ...
    shape: {
      pathD: 'M 105,820 L 252.5,820 L 252.5,960 L 125,960 Q 105,960 105,940 Z',
      centerX: 178,
      centerY: 890,
  ...
  },
  {
    ...
    shape: {
      pathD: 'M 252.5,820 L 400,820 L 400,960 L 252.5,960 Z',
      centerX: 326,
      centerY: 890,
  ...
  },
  {
    ...
    shape: {
      pathD: 'M 400,820 L 547.5,820 L 547.5,960 L 400,960 Z',
      centerX: 474,
      centerY: 890,
  ...
  },
  {
    ...
    shape: {
      pathD: 'M 547.5,820 L 695,820 L 695,940 Q 695,960 675,960 L 547.5,960 Z',
      centerX: 621,
      centerY: 890,
